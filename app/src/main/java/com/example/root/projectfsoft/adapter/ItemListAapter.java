          ...
          if(realm.where(PlaceFavorite.class).equalTo("id",place.getId()).findFirst()!=null) {
              ...
              holder.favorite.setOnClickListener(new View.OnClickListener() {
                  ...
                  public void onClick(View view) {
                      ...
                      RealmResults<com.example.root.projectfsoft.model.ShowImage> resultsImage=realm.where(com.example.root.projectfsoft.model.ShowImage.class).equalTo("id",place.getId()).findAll();
                                  ...
                                  public void next(ListComment data) {
                                      for(int i=0;i<data.getImage().size();i++){
                                          ...
                                          if(null!=data.getImage().get(i).getPhoto_url()) {
                                              ...
                                              System.out.println("the thi sao:"+img.getDrawable().toString());
